 ...
 * generated in the com.example.deepak.soap.mtom.client.wsproxies package. 
...
public class ObjectFactory {
    ...
    private final static QName _Download_QNAME = new QName("http://service.server.mtom.soap.deepak.example.com/", "download");
    private final static QName _DownloadResponse_QNAME = new QName("http://service.server.mtom.soap.deepak.example.com/", "downloadResponse");
    private final static QName _Upload_QNAME = new QName("http://service.server.mtom.soap.deepak.example.com/", "upload");
    private final static QName _UploadResponse_QNAME = new QName("http://service.server.mtom.soap.deepak.example.com/", "uploadResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.example.deepak.soap.mtom.client.wsproxies
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.mtom.soap.deepak.example.com/", name = "download")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.mtom.soap.deepak.example.com/", name = "downloadResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.mtom.soap.deepak.example.com/", name = "upload")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server.mtom.soap.deepak.example.com/", name = "uploadResponse")
